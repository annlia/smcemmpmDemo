...
### First step (sampling from scratch) of the SMCEM procedure for a Probit Model 
...
PbitEMstart <- function(obs, X, p, ncov, estbe = rep(0.5,ncov+1), sigem = diag(p), smcM = 1000){
